...
let AssertEquality (x:'T) (y:'T) = Debug.Assert <| (x=y)
let AssertInequality (x:'T) (y:'T) = Debug.Assert <| not (x=y)
...
AssertEquality (getDinner person2) "Sally  wants 'em some "
...
AssertEquality fruits.[0] "apllle"
AssertEquality fruits.[1] "pear"
...
AssertEquality  result (Seq.cast [2..5])
...
let headers =  splitCommas stockData.Head
